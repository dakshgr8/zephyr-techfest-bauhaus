...
export function HomePage({ onNavigate }) {
  ...
  return (
    <main className="w-full overflow-x-hidden">
      ...
      {/* 2. Portal Grid */}
      <section id="portals" className="py-14 sm:py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-8 sm:space-y-12">
        ...
        <div className="text-center max-w-xl mx-auto space-y-1.5">
          ...
          <h2 className="font-display text-2xl sm:text-4xl font-normal text-[#1C1C1C] tracking-wide uppercase">
          ...
          {portals.map((item) => {
            ...
            return (
              <div
                ...
                className="gallery-card p-5 sm:p-8 lg:p-10 flex flex-col justify-between space-y-5 sm:space-y-6 cursor-pointer group"
              >
                <div className="space-y-2.5 sm:space-y-3">
                  <div className="flex items-center justify-between">
                    <div className="w-7 h-7 sm:w-8 sm:h-8 bg-[#FAF7F2] border border-[#E2DCD2] group-hover:border-[#9E7438] flex items-center justify-center text-[#1C1C1C] group-hover:text-[#9E7438] transition-colors">
                      <Icon className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                    </div>

                    <span className="font-body text-[8.5px] sm:text-[9px] font-medium text-[#6B6862] tracking-[0.2em] uppercase">
                      {item.subtitle}
                    </span>
                  </div>

                  <h3 className="font-display text-xl sm:text-2xl lg:text-3xl font-medium text-[#1C1C1C] group-hover:text-[#9E7438] transition-colors tracking-wide">
                    {item.title}
                  </h3>
                ...
                <div className="pt-2.5 border-t border-[#E2DCD2] flex items-center justify-between font-body text-xs uppercase tracking-[0.2em] text-[#1C1C1C] group-hover:text-[#9E7438] transition-colors">
